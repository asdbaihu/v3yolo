...
class YOLOLayer(nn.Module):
    ...
    def forward(self, p, img_size, emb_ft, var=None):
        ...
        # p.view(bs, 399, 13, 13) -- > (bs, 3, 13, 13, 133)  # (bs, anchors, grid, grid, classes + xywh)
        p = p.view(bs, self.na, self.num_ft + 5, self.ny, self.nx).permute(0, 1, 3, 4, 2).contiguous()  # prediction
